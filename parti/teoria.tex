...
\begin{equation*}
\left| e^{i\lambda } -1\right| \leqslant | \lambda | \ \ \lambda \in \mathbb{R} \ \ \ \ \ \ \ \ \lambda =-xh\ \ \Rightarrow \ \ \text{l'integrale converge per conv. dom.} 
\end{equation*}
\end{proof}
\begin{thm}
...
\end{equation*}ma questa è proprio la definizione di funzione a descrescenza rapida, quindi $\hat{u} \in \mathcal{S}(\mathbb{R})$ e abbiamo dimostrato la tesi.
\end{itemize}
\end{proof}
