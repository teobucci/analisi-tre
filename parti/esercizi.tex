...
\begin{equation*}
f\left( z\right) =u\left( x,y\right) +iv\left( x,y\right) =\Re \left( z\right) +i\mathrm{Im}\left( z\right)
\end{equation*}
...
\begin{equation*}
\begin{aligned}
I^{\star }_{n} & =2\pi i\cdotp \{\Res ( g_{n} ,2ni) +\Res ( g_{n} ,ni)\} =2\pi i\cdotp \left\{-\frac{i}{6n^{3}} +\frac{i}{12n^{3}}\right\}\\
...
\begin{equation*}
\boxed{F( s) :=\int ^{+\infty }_{0} e^{-st} f( t) dt\ \ \ \ \forall s\in \CC  :\Re ( s)  >\lambda _{f}}
\end{equation*}
...
\begin{equation*}
f( z) =\frac{2\left( 1+z^{2}\right) e^{ixz}}{z^{4} +4} \ \ \implies \ \ u( x) =\frac{1}{2\pi } \cdotp 2\pi i\cdotp \sum _{\mathrm{Im}( z_{k})  >0}\Res ( f,z_{k})
\end{equation*}
...
calcoliamo
\begin{align*}
\sum _{\mathrm{Im}( z_{k})  >0}\Res ( f,z_{k}) & =-\frac{1}{8}\left\{( 1+i)( 1+2i) e^{( -1+i) x} +( -1+i)( 1-2i) e^{( -1-i) x}\right\}\\
 & =-\frac{e^{-x}}{8}\left\{( -1+3i) e^{ix} +( 1+3i) e^{-ix}\right\}
\end{align*}
Per le $x >0$
\begin{align*}
u( x) & =i\cdotp \sum _{\mathrm{Im}( z_{k})  >0}\Res ( f,z_{k})\\
