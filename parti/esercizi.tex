...
Poniamo
\begin{equation*}
f\left( z\right) =e^{iz^{2}} \in \Hc \left(\mathbb{C}\right)
\end{equation*}
...
\begin{equation*}
\exists \lim\limits _{z\rightarrow z_{0}} f\left( z\right) \in \mathbb{C} \ \ \iff \ \ M=\emptyset \ \ \iff \ \ f\ \text{è limitata su} \ \Uc \left( z_{0}\right)
\end{equation*}
\item \textbf{polo} se
...
Dimostro che $g_{n}$ converge in $\Sc  '(\mathbb{R})$, da cui si ottiene che $g_{n}$ converge anche in $D'(\mathbb{R})$.
\begin{equation*}
...
\fg{0.7}{15-4}
\begin{equation*}
\Fc \left\{\frac{1}{\cosh x}\right\} =\int _{\mathbb{R}}\frac{e^{-i\xi x}}{\cosh x} dx=\int _{\mathbb{R}}\frac{2e^{-i\xi x}}{e^{x} +e^{-x}} dx\ \ \implies \ \ f( x) =\frac{2e^{-i\xi z}}{e^{z} +e^{-z}}
\end{equation*}
