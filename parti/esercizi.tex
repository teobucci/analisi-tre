...
\begin{equation*}
\Log_{\left( 2\pi \right)} :=\ln z+i\vartheta \ \ \ \ \vartheta \in \arg z\cap \left( 0,2\pi \right)
\end{equation*}
Si considera rispettivamente
\begin{equation*}
\begin{array}{ c l }
A & f\left( z\right) =e^{\alpha \cdotp \Log_{\left( 2\pi \right)} z} R\left( z\right)\\
B & f\left( z\right) =\Log_{\left( 2\pi \right)} z\cdotp R\left( z\right)\\
