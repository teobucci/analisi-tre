...
\end{equation*}
\item su $\gamma _{2}$ dobbiamo cercare una maggiorazione in modo da far vedere che tende a $0$. Ricordiamo anche che $\left| e^{z}\right| =e^{\Re \left( z\right)}$\begin{align*}
...
\left| f-g\right| ^{p} & =\left| \frac{1}{\sqrt{x}} -\frac{1}{\sqrt{x+1}}\right| ^{p} =\left| \frac{\sqrt{x+1} -\sqrt{x}}{\sqrt{x}\sqrt{x+1}}\right| ^{p}\\
 ...
 & \implies \ \ f-g\in L^{p}\left( 1,+\infty \right) \ \ \iff \ \ \frac{3}{2} p >1\ \ \iff \ \ p >\frac{2}{3} \ \text{cioè il primo intero:} \ p\geqslant 1\\
 & \\
...
\begin{equation*}
| f( x)| ^{p}\overset{x\rightarrow 0^{+}}{\sim }\frac{1}{x^{p/2}} \ \ \implies \ \ f\in L^{p}( 0,1) \ \ \iff \ \ \frac{p}{2} < 1\ \ \iff \ \ 1\leqslant p< 2
\end{equation*}
$g$ è limitata in $( 0,1) \implies g\in L^{p}( 0,1) \ \forall p\geqslant 1$, incluso $+\infty $.

$f-g\in L^{p}( 0,1) \iff 1\leqslant p< 2$ dato che so sommando due funzioni, di cui una limitata su intervallo limitato che non presenta problemi e una in $L^{p}$ per $1\leqslant p< 2$.
...
| f_{n}( x)| \leqslant g( x) \coloneqq \frac{x^{2}}{\left( x^{2} +2^{2}\right)^{3/2}\log^{3/2}\left( x^{2} +2^{2}\right)} \in L^{1}( 0,+\infty )
\end{equation*}
\begin{enumerate}
...
\left| \left(\arctan\left(\frac{1}{nx}\right)\right)^{p}\right| \leqslant g( x) \coloneqq \begin{cases}
...
\begin{equation*}
b_{n} =\frac{2}{\pi }\int ^{\pi }_{0} 1\cdot \sin( nx) dx=\frac{2}{\pi }\left[ -\frac{1}{n}\cos( nx)\right]^{\pi }_{0} =\frac{2}{\pi n}\left( 1-( -1)^{n}\right) =\begin{cases}
