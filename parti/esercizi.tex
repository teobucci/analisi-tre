...
I^{\star }_{n} & =\underbrace{\int _{\sigma _{R}} g( z) dz}_{\xrightarrow{R\rightarrow +\infty } 0} +\underbrace{\int ^{R}_{-R} g( z) dz}_{\xrightarrow{R\rightarrow +\infty } I_{n}}\\
 ...
 & \implies \Vert f_{n,\alpha } -F_{\alpha }\Vert _{L^{1}} =n^{\alpha } \cdotp \frac{\pi }{6n^{3}}\xrightarrow{n\rightarrow +\infty } 0\ \ \iff \ \ \alpha < 3\land \alpha \in [ 0,4)
\end{aligned}
\end{equation*}
...
\item $f$ è regolare a tratti in $[ -\pi ,\pi ] \implies $ la serie di Fourier $F( x)$ converge puntualmente $\forall x\in \mathbb{R}$.
\begin{enumerate}
...
\implies \ \ f_{n}\xrightarrow[n\rightarrow +\infty ]{\mathcal{S} '(\mathbb{R})} f\equiv 0
\end{cases}
\end{equation*}
Stimiamo
\begin{equation*}
...
\fg{0.7}{15-4}
\begin{equation*}
\mathcal{F}\left\{\frac{1}{\cosh x}\right\} =\int _{\mathbb{R}}\frac{e^{-i\xi x}}{\cosh x} dx=\int _{\mathbb{R}}\frac{2e^{-i\xi x}}{e^{x} +e^{-x}} dx\ \ \implies \ \ f( x) =\frac{2e^{-i\xi z}}{e^{z} +e^{-z}}
\end{equation*}
Tutte le singolarità sono tutti i punti del piano complesso in cui si annulla il denominatore 
\begin{equation*}
e^{z} +e^{-z} =e^{-z} (e^{2z} +1)=0\ \ \iff \ \ 2z=i\pi +2k\pi \ \ \iff \ \ z=i\frac{\pi }{2} +k\pi ,\ \ k\in \mathbb{Z}
\end{equation*}
...
\\
| \langle ( u-u_{n}) ,\ \psi \rangle | \leqslant \frac{1}{\sqrt{n}} \ \int _{\mathbb{R}}| \psi ( x)| dx\xrightarrow{n\rightarrow \infty } 0\ \ \implies \ \ u_{n}\xrightarrow[\mathcal{S} ']{n\rightarrow \infty } u
\end{gather*}
...
f( t) & =t[ H( t) -H( t-2)] +( 4-t)[ H( t-2) -H( t-4)]\\
 ...
 & \\
 & \implies \ \ \mathcal{L}\{f( t)\} =\frac{1}{s^{2}} -2\frac{e^{-2s}}{s^{2}} +\frac{e^{-4s}}{s^{2}}
\end{aligned}
\end{equation*}
\Esercizio{}
...
g( t) & =t[ H( t) -H( t-1)] +( 2-t)[ H( t-1) -H( t-2)] +( t-2)[ H( t-2)\\
 & \\
 & \implies \ \ \mathcal{L}\{g( t)\} =\frac{1}{s^{2}} -2\frac{e^{-s}}{s^{2}} +2\frac{e^{-2s}}{s^{2}}
\end{aligned}
\end{equation*}
\Esercizio{}
...
Ci ricordiamo che
\begin{equation*}
\mathcal{F}\left\{e^{-\alpha | x| }\right\} =\frac{2\alpha }{\alpha ^{2} +\xi ^{2}} \ \ \implies \ \ u( x) =-\frac{1}{2\alpha } e^{-\alpha | x| }
\end{equation*}
...
ma
\begin{equation*}
\mathcal{F}\left\{e^{-x^{2}}\right\} =\sqrt{\pi } e^{-\frac{\xi ^{2}}{4}} \ \ \implies \ \ u( x) =De^{-x^{2}}
\end{equation*}
...
\end{align*}
\begin{thm}
Date $\displaystyle u,v\in \mathcal{S}(\mathbb{R}) \implies \ \widehat{u*v} =\hat{u} \cdot \hat{v}$.
\end{thm}
\begin{align*}
...
i\xi \cdotp\mathcal{F}( f_{0}( x) ,\xi ) & =\mathcal{F}( f_{0} '( x) ,\xi ) =\pi -\pi e^{-| \xi | }\\
 & \\
 & \implies \ \ \mathcal{F}( f_{0}( x) ,\xi ) =\frac{\pi -\pi e^{-| \xi | }}{i\xi } =i\pi \frac{e^{-| \xi | } -1}{\xi }
\end{align*}
\end{enumerate}
\Soluzione
...
Notiamo che
\begin{equation*}
\omega =1\ \ \implies \ \ \mathcal{L}\{H( t)\sin( t)\} =\frac{1}{s^{2} +1} =:\varphi ( s) \ \ \implies \ \ G( s) =-\frac{1}{2} \varphi '( s)
\end{equation*}
Allora
\begin{equation*}
...
allora
\begin{align*}
\implies \ \ \hat{u}( \xi ) & =\frac{1}{1+\xi ^{2}} \cdotp \mathcal{F}\{\chi _{( -1,1)}( x)\}\\
...
\end{equation*}
\begin{align*}
\implies \ \ sU( s) -1+2U( s) & =2U( s) \cdotp \mathcal{L}\{\sin tH( t)\} +3\mathcal{L}\{\cos t\}\\
...
\begin{equation*}
\mathcal{F}\left\{u^{( n)}( x)\right\} =( i\xi )^{n}\mathcal{F}\{u( x)\} \ \ \implies \ \ \mathcal{F}\{u''( x)\} =-\xi ^{2}\mathcal{F}\{u( x)\}
\end{equation*}
e inoltre che
\begin{equation*}
\frac{d^{n}}{d\xi ^{n}}\mathcal{F}\{u( x)\} =\mathcal{F}\left\{( -ix)^{n} u( x)\right\} \ \ \implies \ \ \mathcal{F}\{xu( x)\} =i\frac{d}{d\xi }\mathcal{F}\{u( x)\}
\end{equation*}
Quindi
\begin{equation*}
...
Allora
\begin{gather*}
\mathcal{L}\left\{\frac{1}{2} t^{2} H( t)\right\} =\frac{1}{s^{3}} \ \ \implies \ \ \mathcal{L}\left\{\frac{1}{2} t^{2} H( t) e^{-t}\right\} =\frac{1}{( s+1)^{3}}\\
\implies \ \ \mathcal{L}\left\{\frac{1}{2}( t-1)^{2} H( t-1) e^{-( t-1)}\right\} =\frac{e^{-s}}{( s+1)^{3}}
\end{gather*}
Quindi
\begin{equation*}
